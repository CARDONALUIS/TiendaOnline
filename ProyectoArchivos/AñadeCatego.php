...
$msg = "";
	...
	if(isset($_GET['txtCategoria']) && isset($_SESSION['idUsuario']) && $_SESSION['isAdmi'] == 1)
	{
		if(isset($_GET['txtCategoria']) != "")
		{
				...
				$qry = "insert into clasificacion (clasificacion) value ('".$_GET['txtCategoria']."')";
...
function VerificarFRMCate()
{
	if(document.getElementById("txtCategoria").value == "" && document.getElementById("txtCategoria").value == "")
	{
		alert("Categoria denegada");
		return false;
	}
...
<div class="layoutPlan" >
	<h1>Agrega Categoria</h1>
	<!--Post para archivos!-->
	<form method="get" action="AñadeCatego.php" onsubmit="return VerificarFRMCate();" >
	Nombre Categoria: <input type="text" name="txtCategoria" id="textCategoria" placeholder="Categoria"><br>
	<input type="submit" value="Subir categoria">
