...
if(isset($_GET['idP']))
{
		...
		$qry = "update usuarios set isAdmi ='0' where idUsuario='".$_GET['idP']."'";
...
<div class="layoutPlan" >
 ...
 <div class="Autenticate">
	...
	$consulta = "select * from usuarios where isAdmi='1' ";
	...
	if(isset($_SESSION['idUsuario']))
	{
		if(mysqli_num_rows($resultado)>0)
		{
		  ...
		  echo "<a style='text-decoration:none; color:black; margin-left:15px;' href='EliminacionAdmi.php?idP=". $registro["idUsuario"]."'>".$i.": ".$registro["Nombre"]."</a>";  		  
		  $i++;	
		  }
		}
	}
