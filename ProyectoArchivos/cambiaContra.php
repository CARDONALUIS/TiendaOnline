...
if(isset($_GET['txtPwdActual']) && isset($_GET['txtPwdNuevo']) && isset($_GET['txtPwdConfirmacion']))
{
	...
	if($_GET['txtPwdActual'] != "" && $_GET['txtPwdNuevo'] != "" && $_GET['txtPwdConfirmacion'] != "" )
	{
		if($_GET['txtPwdNuevo']  == $_GET['txtPwdConfirmacion'] )
		{
			...
			$qry = "update usuarios set Pwd ='".$_GET['txtPwdNuevo']."' where idUsuario='".$_SESSION['idUsuario']."' and Pwd ='".$_GET['txtPwdActual']."'";
...
function verficarFRM()
{

	if(document.getElementById("txtPwdActual").value == "")
	return false;
	
	if(document.getElementById("txtPwdNuevo").value == "")
	return false;
	
	if(document.getElementById("txtPwdConfirmacion").value == "")
	return false;

	
	
	if(document.getElementById("txtPwdNuevo").value !=  document.getElementById("txtPwdConfirmacion").value)
		{
...
<h1>Formulario para cambiar password</h1>
<form method="get" action="cambiaContra.php" onsubmit="return verficarFRM()" >
password actual: <input type="password"id="txtPwdActual" name="txtPwdActual" ><br>
password nuevo: <input type="password" id="txtPwdNuevo" name="txtPwdNuevo"><br>
password confirmar: <input type="password" id="txtPwdConfirmacion" name="txtPwdConfirmacion"><br>
<input type="submit" value="Cambiar pasword">
