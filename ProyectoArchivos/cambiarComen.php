...
if(!isset($_SESSION['idUsuario']))//regreso an partada
{header("Location:http://localhost/Proyecto/portada.php");
}


if(isset($_GET['txtComenNue']))
{
		$conn=ConectarBD();
		$qry = "update comentarios set Comentario ='".$_GET['txtComenNue']."' where idUsuario='".$_SESSION['idUsuario']."' 
		and idComentario ='".$_GET['idCom']."'";	
...
function verficarFRMComen()
{

	if(document.getElementById("txtComenNue").value == "")
	{
	return false;
	}
	else
...
<h1>Cambia tu comentario</h1>
<form method="get" action="cambiarComen.php" onsubmit="return verficarFRMComen()" >
Nuevo Comentario: <input type="text"id="txtComenNue" name="txtComenNue" ><br>
<input type="submit" value="Cambiar comentario">
<input type="hidden" name="idCom" value="<?php echo  $_GET['idCom'];?>">
<input type="reset" value="Cancelar"><br>
<a href="Producto.php">Regresar</a> a portada
